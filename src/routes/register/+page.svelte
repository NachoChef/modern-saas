		...
		<Card class="mt-6 w-full" padding="xl" size="md">
			<form method="POST" class="flex flex-col space-y-6" use:enhance data-testid="register-form">
				<label class="space-y-2" for="full_name">
					<span>Name</span>
					<input type="text" name="full_name" data-testid="full-name" bind:value={$form.full_name} />
					{#if $errors.full_name}
				...
				<label class="space-y-2" for="email">
					<span>Email</span>
					<input type="email" name="email" data-testid="email" bind:value={$form.email} />
					{#if $errors.email}
				...
				<label class="space-y-2" for="password">
					<span>Password</span>
					<input type="password" name="password" data-testid="password" bind:value={$form.password} />
					{#if $errors.password}
				...
				<label class="space-y-2" for="passwordConfirm">
					...
					<input type="password" name="passwordConfirm" data-testid="password-confirm" bind:value={$form.passwordConfirm} />
